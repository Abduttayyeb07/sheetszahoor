...
export interface VaultConfig {
  name: string;
  // The CosmWasm vault contract address. Emits "wasm-vault_deposit" for
  // inflows (subscriptions) and "wasm-vault_redemption_requested" for
  // outflows (a user requesting a specific redemption amount) — both carry
